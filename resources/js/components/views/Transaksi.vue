...
<v-container fluid grid-list-xl>
    <v-layout align-center wrap>
        <v-flex xs12 sm6>
            <v-combobox outline v-model="customer" :items="customers" item-text="nama_pelanggan" label="Nama Pelanggan" item-value="id_customer" value="id_customer" :disabled="isi" @change="inputdata">
        ...
        <template slot="headers" slot-scope="props">
            <tr>
                <th>
                    ...
                    <v-btn v-else  round color="blue darken-4" @click="tambah" dark>Tambah <v-icon right dark>add_circle</v-icon></v-btn>
